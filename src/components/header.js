      ...
      >
        <div class="flex items-center justify-between flex-wrap p-6 max-w-5xl" style={{minWidth: `100px`, maxWidth: `1640px`, width: `100%`}}>
          ...
          <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
            ...
            <div>
              <a href="https://bark-simulator.readthedocs.io/en/latest/" class="inline-block text-base px-4 py-2 leading-none border rounded text-white border-white hover:border-transparent hover:text-blue-800 hover:bg-white mt-4 lg:mt-0 mr-2">Documentation</a>
